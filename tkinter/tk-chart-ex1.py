...
frame0 = tk.Frame(root, bg='purple', width=800, height=100)
frame1 = tk.Frame(root, bg='blue', width=200, height=700, pady=3)
frame2 = tk.Frame(root, bg='green', width=200, height=700, pady=3)
frame3 = tk.Frame(root, bg='red', width=200, height=700, pady=3)
frame4 = tk.Frame(root, bg='yellow', width=200, height=700, pady=3)
